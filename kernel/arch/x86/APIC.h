...
void APIC_Local_SendIPI(uint8_t apicID, uint32_t dsh, uint32_t type, uint8_t vector);


int IAPIC_IO_init();

void IAPIC_IO_SetBase(uintptr_t newBase);
void IAPIC_IO_MapLegacyIRQ(uint8_t irq);
