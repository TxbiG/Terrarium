...
void fat32StatInternal(FAT32TraverseResult *res, terra_stat_t *target) {
...
bool fat32Stat(MountPoint *mnt, char *filename, terra_stat_t *target,
               char **symlinkResolve) {
...
size_t fat32StatFd(OpenFile *fd, terra_stat_t *target) {
